...
var (
	addrTmplListModels             = template.Must(template.New("AddressListModels").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/models"))
	headerTmplListModels           = template.Must(template.New("HeaderListModels").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Authorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplCreateChatCompletion   = template.Must(template.New("AddressCreateChatCompletion").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/chat/completions"))
	headerTmplCreateChatCompletion = template.Must(template.New("HeaderCreateChatCompletion").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: application/json\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplCreateEmbeddings       = template.Must(template.New("AddressCreateEmbeddings").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/embeddings"))
	headerTmplCreateEmbeddings     = template.Must(template.New("HeaderCreateEmbeddings").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: application/json\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplCreateImage            = template.Must(template.New("AddressCreateImage").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/images/generations"))
	headerTmplCreateImage          = template.Must(template.New("HeaderCreateImage").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: application/json\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplCreateImageEdit        = template.Must(template.New("AddressCreateImageEdit").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/images/edits"))
	headerTmplCreateImageEdit      = template.Must(template.New("HeaderCreateImageEdit").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: {{ $.request.ContentType }}\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplCreateImageVariation   = template.Must(template.New("AddressCreateImageVariation").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/images/variations"))
	headerTmplCreateImageVariation = template.Must(template.New("HeaderCreateImageVariation").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: {{ $.request.ContentType }}\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplUploadFile             = template.Must(template.New("AddressUploadFile").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/files"))
	headerTmplUploadFile           = template.Must(template.New("HeaderUploadFile").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: {{ $.request.ContentType }}\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplRetrieveFileContent    = template.Must(template.New("AddressRetrieveFileContent").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/files/{{ $.fileID }}/content"))
	headerTmplRetrieveFileContent  = template.Must(template.New("HeaderRetrieveFileContent").Funcs(template.FuncMap{"trim_trailing_slash": TrimTrailingSlash}).Parse("Authorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
)
