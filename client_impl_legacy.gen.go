...
var (
	addrTmplListModels             = template.Must(template.New("AddressListModels").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/models"))
	headerTmplListModels           = template.Must(template.New("HeaderListModels").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Authorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplCreateChatCompletion   = template.Must(template.New("AddressCreateChatCompletion").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/chat/completions"))
	headerTmplCreateChatCompletion = template.Must(template.New("HeaderCreateChatCompletion").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: application/json\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n{{ encode_json $.request }}"))
	addrTmplCreateEmbeddings       = template.Must(template.New("AddressCreateEmbeddings").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/embeddings"))
	headerTmplCreateEmbeddings     = template.Must(template.New("HeaderCreateEmbeddings").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: application/json\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n{{ encode_json $.request }}"))
	addrTmplCreateImage            = template.Must(template.New("AddressCreateImage").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/images/generations"))
	headerTmplCreateImage          = template.Must(template.New("HeaderCreateImage").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: application/json\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n{{ encode_json $.request }}"))
	addrTmplCreateImageEdit        = template.Must(template.New("AddressCreateImageEdit").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/images/edits"))
	headerTmplCreateImageEdit      = template.Must(template.New("HeaderCreateImageEdit").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: {{ $.request.ContentType }}\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplCreateImageVariation   = template.Must(template.New("AddressCreateImageVariation").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/images/variations"))
	headerTmplCreateImageVariation = template.Must(template.New("HeaderCreateImageVariation").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: {{ $.request.ContentType }}\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplUploadFile             = template.Must(template.New("AddressUploadFile").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/files"))
	headerTmplUploadFile           = template.Must(template.New("HeaderUploadFile").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Content-Type: {{ $.request.ContentType }}\r\nAuthorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
	addrTmplRetrieveFileContent    = template.Must(template.New("AddressRetrieveFileContent").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("{{ trim_trailing_slash $.BaseClient.BaseUrl }}/files/{{ $.fileID }}/content"))
	headerTmplRetrieveFileContent  = template.Must(template.New("HeaderRetrieveFileContent").Funcs(template.FuncMap{"encode_json": EncodeJSON, "trim_trailing_slash": TrimTrailingSlash}).Parse("Authorization: Bearer {{ $.BaseClient.APIKey }}\r\n\r\n"))
)

func (__imp *implBaseClient[C]) ListModels(ctx context.Context) (*Models, error) {
...
func (__imp *implBaseClient[C]) CreateChatCompletion(ctx context.Context, request *ChatCompletionRequest) (ChatCompletion, error) {
...
func (__imp *implBaseClient[C]) CreateEmbeddings(ctx context.Context, request *CreateEmbeddingsRequest) (*Embeddings, error) {
...
func (__imp *implBaseClient[C]) CreateImage(ctx context.Context, request *CreateImageRequest) (*Images, error) {
...
func (__imp *implBaseClient[C]) CreateImageEdit(ctx context.Context, request *CreateImageEditRequest) (*Images, error) {
...
func (__imp *implBaseClient[C]) CreateImageVariation(ctx context.Context, request *CreateImageVariationRequest) (*Images, error) {
...
func (__imp *implBaseClient[C]) UploadFile(ctx context.Context, request *UploadFileRequest) (*File, error) {
...
func (__imp *implBaseClient[C]) RetrieveFileContent(ctx context.Context, fileID string) (io.ReadCloser, string, error) {
...
func (*implBaseClient[C]) response() *ResponseHandler {
